...
def test_get_data(test_url):
    ...
    assert get_data("https://arong.url.com")[0] is None
    assert get_data("https://github.com/MAKARnikanov/git_project")[0] is None
    assert get_data("https://github.com/MAKARnikanov/git_project123")[0] is None

def test_get_filtered_data(test_data):
    assert len(get_filtered_data(test_data)) == 4
    assert len(get_filtered_data(test_data, filtered_from_empty=True)) == 2
